...
public class CalculatorGUI extends JFrame {
	...
	static {
		try {
			intMethod = AuDCalculator.class.getMethod("convertToInt", String.class, int.class);
			numberSystemMethod = AuDCalculator.class.getMethod("convertToNumberSystem", int.class, int.class);
			computeArithmeticMethod = AuDCalculator.class.getMethod("computeArithmetic", int.class, int.class,
